...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="page-title">Staff Sales</h4>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-color panel-primary">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Staff Sales</h3>
                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <select class="selectpicker" name="week" id="week" data-style="btn-default btn-custom">
                                                    <?php foreach($weeks as $week){ ?>
                                                        <option value="<?php echo $week->week_no; ?>" <?php if($curWeek==$week->week_no)echo 'selected'; ?> ><?php echo $week->week_no; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    tblSummary = initTable("#table1",
        ...
        ], "<?php echo site_url('Cms_api/get_result_summary0_by_staff').'/'.$curWeekNo; ?>");
    tblSummary1 = initTable("#table2",
        ...
        ], "<?php echo site_url('Cms_api/get_result_summary_by_staff').'/'.$curWeekNo;  ?>");

        function onSearch() {
            week = document.getElementById('week').value;
            staff = document.getElementById('staff').value;
            let params = '/' + week + '/' + staff;

            tblSummary.ajax.url("<?php echo site_url('Cms_api/get_result_summary0_by_staff') ?>" + params);
            tblSummary.ajax.reload();
            
            tblSummary1.ajax.url("<?php echo site_url('Cms_api/get_result_summary_by_staff') ?>" + params);
